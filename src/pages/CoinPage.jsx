    ...
    try {
      const data = await axios
        ...
        .then(response => {
          ...
          console.log(response.data, "--CoinListing")
        });
      console.log(data, "--showCoinsData")
      setLoading(true);
    } catch (e) {
      console.log(e)
    }
    ...
    <>
      {loading ? <div className='rounded-div my-12 py-8'>
        <div className='flex py-8 '>
          <img className='w-20 mr-8 bg-red-200' src={coin.image?.large} alt="" />
          <div>
        ...
        <div className='grid md:grid-cols-2 gap-8'>
          <div>
            ...
            <div>
              <Sparklines data={coin.market_data?.sparkline_7d.current_price}>
